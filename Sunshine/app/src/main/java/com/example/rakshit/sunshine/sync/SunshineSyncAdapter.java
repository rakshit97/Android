...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter
{
     ...
     *
     * @param activity The context used to access the account service
     */
    public static void syncImmediately(Activity activity)
    {
        ...
        ContentResolver.requestSync(getSyncAccount(activity), activity.getString(R.string.content_authority), bundle);
    }
